...
void show_help() {
  ...
  help_msg << "\nUsage: GangSTR [OPTIONS] "
	   ...
	   << "\t" << "--coverage    <float>         " << "\t" << "Average coverage. must be set for exome/targeted data" << "\n"
	   << "\t" << "--nonuniform                  " << "\t" << "Indicate whether data has non-uniform coverage (i.e., exome)" << "\n"
	   << "\n Advanced paramters for likelihood model:\n"
	   << "\t" << "--frrweight   <float>         " << "\t" << "Weight for FRR reads" << "\n"
	   << "\t" << "--enclweight  <float>         " << "\t" << "Weight for enclosing reads" << "\n"
	   << "\t" << "--spanweight  <float>         " << "\t" << "Weight for spanning reads" << "\n"
	   << "\t" << "--flankweight <float>         " << "\t" << "Weight for flanking reads" << "\n"
	   << "\t" << "--ploidy      <int>           " << "\t" << "Indicate whether data is haploid (1) or diploid (2)" << "\n"
	   << "\t" << "--userofftarget               " << "\t" << "Use off target regions included in the BAM file" << "\n"
	   << "\t" << "--insertmean  <float>         " << "\t" << "Fragment length mean" << "\n"
	   << "\t" << "--insertsdev  <float>         " << "\t" << "Fragment length standard deviation" << "\n"
	   << "\t" << "--insertmax   <float>         " << "\t" << "Maximum insert size" << "\n"
	   << "\t" << "--read-prob-mode              " << "\t" << "Use only read probability (ignore class probability)" << "\n"
	   << "\t" << "--numbstrap   <int>           " << "\t" << "Number of bootstrap samples" << "\n"
	   << "\n Parameters for local realignment:\n"
	   << "\t" << "--minscore    <int>           " << "\t" << "Minimum alignment score (out of 100)" << "\n"
	   << "\t" << "--minmatch    <int>           " << "\t" << "Minimum number of matching basepairs on each end of enclosing reads" << "\n"
	   << "\n Stutter model parameters:\n"
	   << "\t" << "--stutterup   <float>         " << "\t" << "Stutter insertion probability" << "\n"
	   << "\t" << "--stutterdown <float>         " << "\t" << "Stutter deletion probability" << "\n"
	   << "\t" << "--stutterprob <float>         " << "\t" << "Stutter step size parameter" << "\n"
